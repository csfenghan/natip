...
// 1. file类型专属的操作
bool Value::isJsonData() { return data_->head_.detail_type.data_type == JSON_DATA; }
bool Value::isImageData() { return data_->head_.detail_type.data_type == IMAGE_DATA; }
DataType Value::getDataType() { return data_->head_.detail_type.data_type; }

std::string Value::asStringData() {
...
// 2. cmd类型专属的操作
bool Value::isMessageCmd() { return data_->head_.detail_type.cmd_type == STRING_MASSAGE; }
...
// 3. error类型专属的操作
bool Value::isFormatError() { return data_->head_.detail_type.error_type == FORMAT_ERROR; }
